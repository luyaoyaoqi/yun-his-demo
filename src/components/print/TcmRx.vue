        ...
        <template #header>
            <div class="header">
                <div class="header-left">
                    ...
                    <div class="service">
                        <div class="service-item" data-visible="tcmProcessInfo">加工</div>
            ...
            <div class="patient-basic-info">
                ...
                <div class="info-item">
                    日期：
                    <span data-field="visitDate">2023-06-28</span>
                </div>
            </div>
            ...
            <div class="patient-detail-info">
                <div class="info-item" data-visible="organizationMSC">
                    机构编码：
                    <span data-field="organizationMSC">B11010500123</span>
                </div>
                <div class="info-item row-two" data-visible="doctorMSC">
                    医生编码：
                    <span data-field="doctorMSC">D110108005678</span>
                </div>
                <div class="info-item">
                    科室：
                    <span data-field="department">中医科</span>
                </div>
                <div class="info-item">
                    费别：
                    <span data-visible="feeType" data-field="feeType">城乡居民医保</span>
                ...
                <div class="info-item" data-visible="personalNo">
                    个人编号：
                    <span data-field="personalNo">GR9876543</span>
                </div>
                <div class="info-item" data-visible="archiveNo">
                    档案号：
                    <span data-field="archiveNo">D123456</span>
                </div>
                <div class="info-item" data-visible="birthDate">
                    出生日期：
                    <span data-field="birthDate">1978-06-15</span>
                </div>
                <div class="info-item" data-visible="weight">
                    体重：
                    <span data-field="weight">72kg</span>
                </div>
                <div class="info-item" data-visible="maritalStatus">
                    婚否：
                    <span data-field="maritalStatus">已婚</span>
                </div>
                <div class="info-item" data-visible="nationality">
                    民族：
                    <span data-field="nationality">满族</span>
                </div>
                <div class="info-item" data-visible="job">
                    职业：
                    <span data-field="job">教师</span>
                </div>
            ...
            <div class="chinese-medicine-section-item" data-field="tcmList">
                <div class="medicine-item one-third">
                    ...
                    <div class="medicine-body">
                        ...
                        <div class="grams-dose" data-visible="tcmDose">
                            <span>12g</span>
                            <span class="grams-total" data-visible="tcmTotalDose">/ 36g</span>
                        </div>
                    </div>
                </div>
                <div class="medicine-item one-third">
                    ...
                    <div class="medicine-body">
                        ...
                        <div class="grams-dose" data-visible="tcmDose">
                            <span>15g</span>
                            <span class="grams-total" data-visible="tcmTotalDose">/ 45g</span>
                        </div>
                    </div>
                </div>
                <div class="medicine-item one-third">
                    ...
                    <div class="medicine-body">
                        ...
                        <div class="grams-dose" data-visible="tcmDose">
                            <span>10g</span>
                            <span class="grams-total" data-visible="tcmTotalDose">/ 30g</span>
                        </div>
                    </div>
                </div>
                <div class="medicine-item one-third">
                    ...
                    <div class="medicine-body">
                        ...
                        <div class="grams-dose" data-visible="tcmDose">
                            <span>9g</span>
                            <span class="grams-total" data-visible="tcmTotalDose">/ 27g</span>
                        </div>
                    </div>
                </div>
                <div class="medicine-item one-third">
            ...
            <div class="usage-section">
                ...
                <div class="usage-content">
                    <div class="usage-item">
                        共
                        <span data-field="tcmDosage"> 3 </span>
                        剂，
                    </div>
                    <div class="usage-item" data-visible="tcmTotalWeight">
                        <span data-field="tcmMedicineCount">6</span>
                        味，
                        单剂
                        <span data-field="tcmTotalDose">68.00</span>
                        g，
                        总重
                        <span data-field="tcmTotalWeight">204.00</span>
                        g，
                    </div>
                    <div class="usage-item" data-field="tcmUsage">煎服，1日1剂，1日2次，每次200ml，饭前30分钟服用</div>
                </div>
            </div>
            <div class="processing-section" data-visible="tcmProcessInfo">
                <div class="processing-label">加工</div>
                <div class="processing-separator">：</div>
                <div class="processing-content" data-field="tcmProcessInfo">手工煎药，1剂煎 2 袋</div>
            </div>
            <div class="delivery-section" data-visible="deliveryInfo">
                ...
                <div class="delivery-content">
                    <div class="delivery-item">
                        <span data-field="deliveryMethod">圆通-到付，</span>
                        <span data-field="deliveryName">张伟 </span>
                        <span data-field="deliveryMobile">13787654321</span>
                    </div>
                    <div class="delivery-item" data-field="deliveryAddress">北京市海淀区中关村大街1号</div>
                </div>
            </div>
